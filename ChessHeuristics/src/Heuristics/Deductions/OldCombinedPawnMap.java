...
public class OldCombinedPawnMap extends AbstractDeduction {
    private final OldPawnMap white;
    private final OldPawnMap black;
    ...
    public OldCombinedPawnMap(OldPawnMap white, OldPawnMap black, OldCombinedPawnMap combinedPawnMap) {
    ...
    public OldCombinedPawnMap(OldPawnMap white, OldPawnMap black) {
        this.black = black;
        this.white = white;
    }
...
//        System.out.println(minimumCaptures(true));
    ...
    protected boolean exclude(BoardInterface board, boolean white) {
        OldPawnMap checkedPlayer = white
                ? this.white
                : this.black;
        OldPawnMap opposingPlayer = white
                ? this.black
                : this.white;
...
//                                    (p2.contains(entry.getKey()) || entry.getValue().get(0).contains(p2.getLast())) &&
    ...
    public OldPawnMap getPawnMap(boolean white) {
