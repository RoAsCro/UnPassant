...
public abstract class OldPawnMap extends AbstractDeduction {
    ...
    public OldPawnMap(OldPawnMap pawnMap) {
    ...
    public OldPawnMap(Boolean white, PawnNumber pawnNumber, PieceNumber pieceNumber) {
        this.white = white;
