...
public class PawnMapTest {
    ...
    void testPawnMapsPawnPositions() {
        ...
        this.testImpossibleStateDetector.testState(board);
        System.out.println(this.testImpossibleStateDetector.getPawnOrigins(true));
        this.testImpossibleStateDetector.getPawnOrigins(true).entrySet().stream().forEach(entry ->{
            Assertions.assertEquals(1, entry.getValue().size());
        });

        this.testImpossibleStateDetector.testState(board);
        System.out.println(this.testImpossibleStateDetector.getPawnOrigins(false));
        this.testImpossibleStateDetector.getPawnOrigins(false).entrySet().stream().forEach(entry ->{
            Assertions.assertEquals(1, entry.getValue().size());
        });
        Assertions.assertTrue(this.pawnMapWhite.getState());
        Assertions.assertTrue(this.pawnMapBlack.getState());
...
//        board = new BoardInterface(BoardBuilder.buildBoard("r3k2r/p7/1pp5/2p5/2P5/1PP5/P7/4K3 w kq - 0 1"));
        this.testImpossibleStateDetector.testState(board);
        System.out.println(this.testImpossibleStateDetector.getPawnOrigins(true));
        Assertions.assertEquals(1, this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(2, 3)).size());

        
        this.testImpossibleStateDetector.testState(board);
        System.out.println(this.testImpossibleStateDetector.getPawnOrigins(false));
        Assertions.assertEquals(1, this.testImpossibleStateDetector.getPawnOrigins(false).get(new Coordinate(2, 4)).size());
        Assertions.assertTrue(this.pawnMapWhite.getState());
        Assertions.assertTrue(this.pawnMapBlack.getState());
    }
    ...
    void testPawnMapsThree() {
        ...
        this.testImpossibleStateDetector.testState(board);
        System.out.println(this.testImpossibleStateDetector.getPawnOrigins(true));
        Assertions.assertEquals(1, this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(1, 2)).size());
        Assertions.assertEquals(1, this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(2, 1)).size());
        Assertions.assertEquals(1, this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(2, 2)).size());
        Assertions.assertEquals(2, this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(3, 2)).size());
        Assertions.assertEquals(2, this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(4, 2)).size());
        Assertions.assertEquals(1, this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(5, 1)).size());
        Assertions.assertEquals(1, this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(7, 1)).size());
        Assertions.assertEquals(1, this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(6, 1)).size());
        Assertions.assertTrue(this.pawnMapWhite.getState());
    }
    ...
    void testPawnMapFour() {
        ...
        this.testImpossibleStateDetector.testState(board);
        System.out.println(this.testImpossibleStateDetector.getPawnOrigins(false));
        Assertions.assertEquals(1, this.testImpossibleStateDetector.getPawnOrigins(false).get(new Coordinate(0, 6)).size());
        Assertions.assertEquals(3, this.testImpossibleStateDetector.getPawnOrigins(false).get(new Coordinate(1, 4)).size());
        Assertions.assertEquals(4, this.testImpossibleStateDetector.getPawnOrigins(false).get(new Coordinate(1, 3)).size());
        Assertions.assertEquals(3, this.testImpossibleStateDetector.getPawnOrigins(false).get(new Coordinate(3, 5)).size());
        Assertions.assertEquals(2, this.testImpossibleStateDetector.getPawnOrigins(false).get(new Coordinate(4, 5)).size());
        Assertions.assertEquals(1, this.testImpossibleStateDetector.getPawnOrigins(false).get(new Coordinate(5, 5)).size());
        Assertions.assertTrue(this.pawnMapBlack.getState());
    ...
    void testPawnMapFive() {
        ...
        System.out.println(this.testImpossibleStateDetector.getPawnOrigins(true));
        Assertions.assertEquals(1, this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(2, 2)).size());
        Assertions.assertEquals(new Coordinate(1, 1), this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(2, 2)).get(0));
        Assertions.assertTrue(this.pawnMapWhite.getState());
    ...
    void testCaptures() {
        ...
        this.testImpossibleStateDetector.testState(board);
        Assertions.assertEquals(1, this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(1, 2)).size());
        Assertions.assertEquals(new Coordinate(1, 1), this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(1, 2)).get(0));
        Assertions.assertTrue(this.pawnMapWhite.getState());
    }
    ...
    void testContradictoryCaptures() {
        ...
        System.out.println(this.testImpossibleStateDetector.getPawnOrigins(true));
        Assertions.assertEquals(1, this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(0, 3)).size());
        Assertions.assertEquals(new Coordinate(0, 1), this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(0, 3)).get(0));
        Assertions.assertTrue(this.pawnMapWhite.getState());
    ...
    void testCapturesThree() {
        ...
        System.out.println(this.testImpossibleStateDetector.getPawnOrigins(true));
        Assertions.assertEquals(1, this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(4, 3)).size());
//        Assertions.assertEquals(new Coordinate(0, 1), this.pawnMapWhite.getPawnOrigins().get(new Coordinate(0, 3)).get(0));
    ...
    void testCapturesFour() {
        ...
        System.out.println(this.testImpossibleStateDetector.getPawnOrigins(true));
        Assertions.assertEquals(2, this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(4, 3)).size());
        Assertions.assertTrue(this.pawnMapWhite.getState());
...
//        Assertions.assertEquals(new Coordinate(0, 1), this.pawnMapWhite.getPawnOrigins().get(new Coordinate(0, 3)).get(0));
    ...
    void testCapturesSix() {
        ...
        System.out.println(this.testImpossibleStateDetector.getPawnOrigins(true));
        Assertions.assertEquals(1, this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(2, 3)).size());
        Assertions.assertEquals(1, this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(5, 3)).size());
//        Assertions.assertEquals(new Coordinate(0, 1), this.pawnMapWhite.getPawnOrigins().get(new Coordinate(0, 3)).get(0));
        Assertions.assertTrue(this.pawnMapWhite.getState());
    ...
    void testCapturesSeven() {
        ...
        System.out.println(this.testImpossibleStateDetector.getPawnOrigins(true));
        Assertions.assertEquals(2, this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(2, 3)).size());
        Assertions.assertEquals(2, this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(5, 3)).size());
//        Assertions.assertEquals(new Coordinate(0, 1), this.pawnMapWhite.getPawnOrigins().get(new Coordinate(0, 3)).get(0));
        Assertions.assertTrue(this.pawnMapWhite.getState());
    ...
    void testCapturesEight() {
        ...
        System.out.println(this.testImpossibleStateDetector.getPawnOrigins(true));
        Assertions.assertEquals(1, this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(6, 2)).size());
        Assertions.assertEquals(1, this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(7, 2)).size());
        Assertions.assertTrue(this.pawnMapWhite.getState());
    ...
    void testCapturesNine() {
        ...
        for (int i = 0 ; i < 8 ; i++) {
            ...
            Assertions.assertEquals(1, this.testImpossibleStateDetector.getPawnOrigins(true).get(new Coordinate(i, 2)).size());
        }
        Assertions.assertTrue(this.pawnMapWhite.getState());
