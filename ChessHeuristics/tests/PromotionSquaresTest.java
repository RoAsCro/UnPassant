...
public class PromotionSquaresTest {
    ...
    void testReachablePawnWithEnoughCaptures() {
        Assertions.assertTrue(test("rnbqk1nr/pp1ppp1p/1p3p2/8/8/8/1PPPPPPP/RNBQKB1R w KQkq - 0 1"));
    }

    @Test
    void testReachablePawn() {
        Assertions.assertTrue(test("rnbqk1nr/p1pppp1p/p4p2/8/8/8/1PPPPPPP/RNBQKB1R w KQkq - 0 1"));
    }

    @Test
    void testUnReachableWrongDirection() {
        //This scenario is not covered by the current implementation
//        Assertions.assertFalse(test("rnbqkbnr/pppppp1p/8/4P3/8/8/PPPPP1PP/RNBQKBNR w KQkq - 0 1"));
    }

    @Test
    void testUnReachableWrongDirectionTwo() {
        Assertions.assertFalse(test("rnbqkbnr/pppppp1p/8/8/8/4P3/PPPPP1PP/RNBQKBNR w KQkq - 0 1"));
    }
    @Test
    void testUnReachableRightDirection() {
        Assertions.assertTrue(test("rnbqkbnr/pppppp1p/5p2/8/8/8/PPPPP1PP/RNBQKBNR w KQkq - 0 1"));
    }

    @Test
    void extraCapture() {
        Assertions.assertTrue(test("rnbqkbnr/pppppp1p/8/4p3/8/8/PPPP1PPP/RNBQKB1R w KQkq - 0 1"));
    }

    @Test
    void twoCaptures() {
        Assertions.assertTrue(test("rnbqkbnr/1ppppp1p/1p6/4p3/8/8/PPPP2PP/RNBQKB1R w KQkq - 0 1"));
    }

    @Test
    void promotion() {
        Assertions.assertTrue(test("rnbqkbnr/1pp1pp2/1pp3p1/4p3/8/8/PPP3PP/R1BQKB1R w KQkq - 0 1"));
        System.out.println(this.pps.getPromotionPaths(true));
    }

    @Test
    void promotionNoPath() {
        Assertions.assertFalse(test("rnbqkbnr/pppp1ppp/5p2/8/8/8/PPPPPP1P/RNBQKBNR w KQkq - 0 1"));
        System.out.println(this.pps.getPromotionPaths(true));
    }
    @Test
    void promotionNoPathDueToCage() {
        Assertions.assertFalse(test("rn2kbnr/pppp1ppp/5p2/8/8/8/PP1PPPPP/RNBQKBNR w KQkq - 0 1"), (this.pps.getPromotionPaths(true).toString()));
        System.out.println(this.pps.getPromotionPaths(true));
    }

    @Test
    void promotionPathDueToCaged() {
        Assertions.assertTrue(test("1nbqkbnr/p1pp1ppp/1p3p2/8/8/8/PP1PPPPP/RNBQKBNR w KQk - 0 1"), (this.pps.getPromotionPaths(true).toString()));
        System.out.println(this.pps.getPromotionPaths(true));
    }

    @Test
    void promotionNoPathDueToCagedOnOtherSide() {
        Assertions.assertFalse(test("rnbqkbn1/p1pppppp/p7/8/8/8/PP1PPPPP/RNBQKBNR w KQ - 0 1"), (this.pps.getPromotionPaths(true).toString()));
        System.out.println(this.pps.getPromotionPaths(true));
    }
    @Test
